...
var controller = (function(budgetCtrl, UICtrl){ 
	...
	document.querySelector(DOM.container).addEventListener('click', cltrlDeleteItem);
	...
	var updatePercentage = function(){
		...
		//3.upadate the ui with the new percentages
	...
	var ctrlAddItem = function(){
		...
		var cltrlDeleteItem=function(event){
